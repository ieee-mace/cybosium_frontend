...
let countDownDate = new Date("Feb 24, 2023 00:00:00").getTime();
...
let x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown-timer").innerHTML = "<li class='hours'><strong>Event Live Now</strong></li>";
  }
}, 1000);
